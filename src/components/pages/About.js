...
export default function About() {
  return (
    <div>
      <img src={imgOfMe} alt="Hayden"/>
      <h1>About Page</h1>
      <p>Hello everyone, in this section I will tell you a little about me. I grew up in Michigan and moved to Arizona to pursue a better life path.
